...
import {AllProgressions} from "../progressions/progressions.styles.ts";
                ...
                <>
                                                ...
                                                <Badges>
                                                    <BadgeInfo>
                                                        {badges?.imageBookBadge == "" ? null :
                                                            <img src={badges?.imageBookBadge}
                                                                 alt="Conquistas do usuário"/>
                                                        }
                                                    ...
                                                    <BadgeInfo>
                                                        {badges?.imagePaginometerBadge == "" ? null :
                                                            <img src={badges?.imagePaginometerBadge}
                                                                 alt="Conquistas do usuário"/>
                                                        }
                                                    ...
                                                    <BadgeInfo>
                                                        {badges?.imageReviewBadge == "" ? null :
                                                            <img src={badges?.imageReviewBadge}
                                                                 alt="Conquistas do usuário"/>
                                                        }
                    ...
                    <ProfileBookInfo>
                        <div>
                            ...
                            {reviewsLoading ? <ReviewProfileSkeletons/> : reviews?.length === 0 ?
                                <p>O usuário ainda não fez nenhuma avaliação.</p> :
                                <ProfilerReviews>
                        ...
                        <div>
                            ...
                            {progLoading ? <ReviewProfileSkeletons/> : progressions?.length === 0 ?
                                <p>O usuário ainda não fez nenhuma progressão.</p> :
                                <AllProgressions id="all-progressions">
                                    {
                                        progressions.slice(0, 10).map((progression, index) => (
                                            <ProgressionsCard
                                                key={index}
                                                isEditable={false}
