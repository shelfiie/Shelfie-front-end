...
import { BoxWrapper, Icons, ReviewDate, ReviewDetails, ReviewsContent, TitleRating } from "./reviews-box.styles";
...
export const ReviewsBox = () => {
    ...
    const charsPerPage = 3000; // Defina um limite de caracteres por página
